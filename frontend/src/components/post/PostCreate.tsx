...
const Login: React.FC<Props> = ({}) => {
	const createDraftMutation = useMutation<CreateDraftMutationResponse>(CREATE_DRAFT_MUTATION)
	...
	return (
		<Box p={1} clone>
			<Paper>
				<h1>Create Draft</h1>
				<Formik initialValues={{ title: '' }} validationSchema={PostCreateSchema} onSubmit={handleSubmit}>
					{({
						values,
						errors,
						touched,
